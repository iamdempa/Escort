...
if (!mysqli_stmt_prepare($stmt, $sqlPartOne)) {
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-6 text-center">
            <div class="btn-group">
                <button type="button" id="<?php echo $adId; ?>" class="btn btn-danger" onclick="showDeclineConfirm(this)"><i class="fa fa-close"></i> Decline</button>
            ...
            <div class="btn-group">
                <button type="button" class="btn btn-success" onclick="deleteAdConfirm(this)" id="<?php echo $adId; ?>"><i class="fa fa-check"></i> Delete</button>
...
//                    alert(php_script_response); // display response from the PHP script, if any
    ...
    <script type="text/javascript">
        function showDeclineConfirm(id) {
            $.confirm({
                title: 'Decline Ad!',
